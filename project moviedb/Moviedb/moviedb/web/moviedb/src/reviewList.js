...
export default function ReviewList(props) {
  ...
  useEffect(() => {
    ...
    fetch("https://moviedb.herokuapp.com/"+props.type+"/"+id+"/reviews").then(resp => resp.json()).then((data) => setReviews(data));
  },[])
  ...
  return (
    ...
    { reviews?reviews.map(x=> (
      <ListItem button>
        <Link href={ "/user/"+x.user_id }><Avatar alt="moviedb" src={ x.pic } className={classes.avatar} /></Link>
